...
clear;clear;clear
echo -e "${BlueBee}╔════════════════════════════════════════════════╗${NC}"
echo -e "\033[96;1m                     KENCANA - VPN               \033[0m"
echo -e "${BlueBee}╚════════════════════════════════════════════════╝${NC}"
echo ""
echo ""
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/yudhapermana999/izinsc/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/yudhapermana999/izinsc/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/yudhapermana999/izinsc/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/yudhapermana999/yudha/main/"
start=$(date +%s)
secs_to_human() {
...
TIMES="10"
CHATID="1634894883"
KEY="6998768380:AAHf0xwhHr0MGVT4BaO8HwBo77NJ5G85jYk"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/yudhapermana999/izinsc/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/yudhapermana999/izinsc/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/kencana404"},{"text":"Contack","url":"wa.me/6285807254128"}]]}'
...
wget "http://raw.githubusercontent.com/yudhapermana999/yudha/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh"
cd
...
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
echo -e "\e[96;1m              ----[  KENCANA - VPN ]----                    \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo ""
echo -e "\e[95;1m  Whatsapp : 6285807254128 \e[0m"
echo -e "\e[95;1m  Telegram : @kencana404 \e[0m"
echo ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
